...
Point Model::getFunctionLocation() const
{
...
const std::string &Model::getMagnitudeENotation() const
{
    return magnitudeENotation;
}

void Model::setMagnitudeENotation(const std::string &newMagnitudeENotation)
{
    magnitudeENotation = newMagnitudeENotation;
}
